...
//hack to get the response status
//https://github.com/opentracing-contrib/go-stdlib/blob/master/nethttp/status-code-tracker.go
...
func (w *statusResponseWriter) wrappedResponseWriter() http.ResponseWriter {
	var (
