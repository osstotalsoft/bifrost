...
func AuthorizationFilter() func(endpoint types.Endpoint) func(next http.Handler) http.Handler {
	...
	return func(endpoint types.Endpoint) func(next http.Handler) http.Handler {
